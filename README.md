...
This repository contains the code and models for predicting customer purchase behavior for the "Trips & Travel.Com" company. 

## Project Overview

- **Objective:** Predict customer purchase behavior for a new Wellness Tourism Package.
- **Models Used:** Random Forest, XGBoost.
- **Data:** Historical customer data used for training and testing the models.
...
Basic, Standard, Deluxe, Super Deluxe, King. Looking at the data of the last year, we observed that 18% of the customers purchased the packages. 
